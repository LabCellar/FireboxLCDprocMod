...
pkglibexecdir = $(libexecdir)/lcdproc
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
build_triplet = amd64-unknown-freebsd10.3
host_triplet = amd64-unknown-freebsd10.3
subdir = .
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	$(top_srcdir)/configure $(am__configure_deps) \
	$(srcdir)/config.h.in COPYING ChangeLog INSTALL README TODO \
...
ACLOCAL = ${SHELL} /root/lcdproc-0.5.7/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /root/lcdproc-0.5.7/missing autoconf
AUTOHEADER = ${SHELL} /root/lcdproc-0.5.7/missing autoheader
AUTOMAKE = ${SHELL} /root/lcdproc-0.5.7/missing automake-1.14
AWK = nawk
CC = cc
...
FT2_CONFIG = no
FT2_LIBS = 
GLCD_DRIVERS =  glcd-glcd-t6963.o t6963_low.o
GREP = /usr/bin/grep
HD44780_DRIVERS = hd44780-hd44780-serial.o hd44780-hd44780-lis2.o hd44780-hd44780-usblcd.o hd44780-hd44780-4bit.o hd44780-hd44780-ext8bit.o hd44780-lcd_sem.o hd44780-hd44780-winamp.o hd44780-hd44780-serialLpt.o hd44780-hd44780-ethlcd.o hd44780-hd44780-i2c.o hd44780-hd44780-piplate.o
...
LIBXOSD_LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /root/lcdproc-0.5.7/missing makeinfo
MKDIR_P = ./install-sh -c -d
OBJEXT = o
PACKAGE = lcdproc
PACKAGE_BUGREPORT = lcdproc@lists.omnipotent.net
PACKAGE_NAME = lcdproc
PACKAGE_STRING = lcdproc 0.5.7
...
XMLTO = no
_png_config = 
abs_builddir = /root/lcdproc-0.5.7
abs_srcdir = /root/lcdproc-0.5.7
abs_top_builddir = /root/lcdproc-0.5.7
abs_top_srcdir = /root/lcdproc-0.5.7
ac_ct_CC = 
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /root/lcdproc-0.5.7/install-sh
